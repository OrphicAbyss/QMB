...
typedef enum m_state_e {
	m_none, m_main, m_singleplayer, m_load, m_save, m_multiplayer, m_setup, m_net, m_options, m_video, m_keys, m_help, m_quit, m_serialconfig, m_modemconfig, m_lanconfig, m_gameoptions, m_search, m_slist, m_vid_options, m_credits
} m_state_t;
m_state_t m_state;
...
void M_Centerprint(int cy, const char *str) {
	int cx;
	cx = vid.conwidth / 2 - (strlen(str)*4);
...
void M_Menu_Setup_f(void) {
	...
	m_state = m_setup;
	m_entersound = true;
	strcpy(setup_myname, cl_name.getString());
	strcpy(setup_hostname, hostname.getString());
...
forward:
		...
		case K_ENTER:
			...
			// setup_cursor == 4 (OK)
			if (strcmp(cl_name.getString(), setup_myname) != 0)
				Cbuf_AddText(va("name \"%s\"\n", setup_myname));
			if (strcmp(hostname.getString(), setup_hostname) != 0)
...
void M_Help_Draw(void) {
	...
	if (help_page == HELP_MOVEMENT) {
		...
		y = 52;
		M_PrintWhite(16, y, "BASIC MOVEMENT");
		y += 8;
		y += 8;
		M_Print(16, y, "  Use the arrow keys to turn and");
		y += 8;
		M_Print(16, y, "  move in the direction you're");
		y += 8;
		M_Print(16, y, "  facing. Holding the SHIFT key");
		y += 8;
		M_Print(16, y, "  down will speed your movement.");
		y += 8;
		M_Print(16, y, "  To reconfigure your keys and");
		y += 8;
		M_Print(16, y, "  mouse buttons, select the");
		y += 8;
		M_Print(16, y, "  CUSTOMIZE KEYS from OPTIONS.");
		y += 8;
		M_Print(16, y, "  menu.");
		y += 8;
		y += 16;
		M_PrintWhite(16, y, "LOOKING AROUND");
		y += 8;
		y += 8;
		M_Print(16, y, "  You can use the A and Z keys");
		y += 8;
		M_Print(16, y, "  to look up and down. A better");
		y += 8;
		M_Print(16, y, "  way to look around use the");
		y += 8;
		M_Print(16, y, "  mouse. It allows you to");
		y += 8;
		...
		y = 52;
		M_Print(16, y, "  It is very important to get");
		y += 8;
		M_Print(16, y, "  used to looking around because");
		y += 8;
		M_Print(16, y, "  many enemies come from above");
		y += 8;
		M_Print(16, y, "  and if you want to swim it");
		y += 8;
		M_Print(16, y, "  is a must.");
		y += 8;
		y += 16;
		M_PrintWhite(16, y, "JUMPING AND SWIMMING");
		y += 8;
		y += 8;
		M_Print(16, y, "  To jump up, press the SPACEBAR.");
		y += 8;
		M_Print(16, y, "  When you are in water, pressing");
		y += 8;
		M_Print(16, y, "  the SPACEBAR will make you");
		y += 8;
		M_Print(16, y, "  swim directly up to the surface");
		y += 8;
		M_Print(16, y, "  no matter which direction you");
		y += 8;
		M_Print(16, y, "  are facing - this is a good");
		y += 8;
		...
		y = 52;
		M_Print(16, y, "  To swim in a certain direction,");
		y += 8;
		M_Print(16, y, "  look into that direction and");
		y += 8;
		M_Print(16, y, "  and press the UP arrow to move");
		y += 8;
		M_Print(16, y, "  forward. DO NOT swim in green");
		y += 8;
		M_Print(16, y, "  slime or lava, unless you have");
		y += 8;
		M_Print(16, y, "  a Biosuit.");
		y += 8;
		y += 8;
		p = Draw_CachePic("gfx/qmb_menu_help_hazards.lmp");
		M_DrawTransPic((320 - p->width) / 2, y, p);
		y += p->height + 16;
		M_PrintWhite(16, y, "OPENING DOORS AND PUSHING BUTTONS");
		y += 8;
		y += 8;
		M_Print(16, y, "  To open doors and push buttons,");
		y += 8;
		M_Print(16, y, "  merely touch them by moving");
		y += 8;
		M_Print(16, y, "  into them. If a door cannot be");
		y += 8;
		...
		y = 52;
		M_Print(16, y, "  If a door needs a key, get the");
		y += 8;
		M_Print(16, y, "  key and come back and touch");
		y += 8;
		M_Print(16, y, "  the door.");
		y += 8;
		y += 8;
		p = Draw_CachePic("gfx/qmb_menu_help_keys.lmp");
		M_DrawTransPic((320 - p->width) / 2, y, p);
		y += p->height + 16;
		M_Print(16, y, "  Most of the time, pressing a");
		y += 8;
		M_Print(16, y, "  button will affect an object");
		y += 8;
		M_Print(16, y, "  nearby. Some buttons can be");
		y += 8;
		M_Print(16, y, "  pressed multiple times - You will");
		y += 8;
		M_Print(16, y, "  see them press in, them come");
		y += 8;
		M_Print(16, y, "  back out, ready for another");
		y += 8;
		M_Print(16, y, "  press. Most buttons animate so");
		y += 8;
		M_Print(16, y, "  they are easy to locate.");
		y += 8;
		y += 8;
		...
		y = 52;
		M_PrintWhite(16, y, "SHOOTING BUTTONS AND SECRET WALLS");
		y += 8;
		y += 8;
		M_Print(16, y, "  Some buttons must be shot");
		y += 8;
		M_Print(16, y, "  (or hit with your axe) to use");
		y += 8;
		M_Print(16, y, "  them.");
		y += 8;
		y += 8;
		...
		M_DrawTransPic((320 - p->width) / 2, y, p);
		y += p->height + 16;
		M_Print(16, y, "  To find secret areas, look for");
		y += 8;
		M_Print(16, y, "  walls that have a texture on");
		y += 8;
		M_Print(16, y, "  them that is different than");
		y += 8;
		M_Print(16, y, "  the surrounding walls, then");
		y += 8;
...
void M_Credits_Draw(void) {
	...
	if (credits_page == CREDITS_QMB) {
		...
		y = 56;
		M_PrintWhite(16, y, "Programming and Project Lead");
		y += 8;
		M_Print(16, y, " Dr. LabMan");
		y += 8;
		y += 8;
		M_PrintWhite(16, y, "Mod Programming and Sounds");
		y += 8;
		M_Print(16, y, " Necrophilissimo");
		y += 8;
		y += 16;
		...
		y = 28;
		M_PrintWhite(16, y, "Programming        Art");
		y += 8;
		M_Print(16, y, " John Carmack       Adrian Carmack");
		y += 8;
		M_Print(16, y, " Michael Abrash     Kevin Cloud");
		y += 8;
		M_Print(16, y, " John Cash          Paul Steed");
		y += 8;
		M_Print(16, y, " Dave 'Zoid' Kirsch");
		y += 8;
		y += 8;
		M_PrintWhite(16, y, "Design             Biz");
		y += 8;
		M_Print(16, y, " John Romero        Jay Wilbur");
		y += 8;
		M_Print(16, y, " Sandy Petersen     Mike Wilson");
		y += 8;
		M_Print(16, y, " American McGee     Donna Jackson");
		y += 8;
		M_Print(16, y, " Tim Willits        Todd Hollenshead");
		y += 8;
		y += 8;
		...
		y += 8;
		y += 8;
		M_PrintWhite(16, y, "Sound Effects");
		y += 8;
		M_Print(16, y, " Trent Reznor and Nine Inch Nails");
		y += 8;
		y += 16;
		M_PrintWhite(16, y, "Quake is a trademark of Id Software,");
		y += 8;
		M_PrintWhite(16, y, "inc., (c)1996 Id Software, inc. All");
		y += 8;
		M_PrintWhite(16, y, "rights reserved. NIN logo is a");
		y += 8;
		M_PrintWhite(16, y, "registered trademark licensed to");
		y += 8;
		M_PrintWhite(16, y, "Nothing Interactive, Inc. All rights");
		y += 8;
